...
test('Request id', t => {
  ...
  t.test('Custom generateRequestId', t => {
    ...
    client.request({}, options, t.error)
  })
  ...
  t.test('Custom request id in method options', t => {
    ...
    client.request({}, { id: 'custom-id' }, t.error)
  })
...
test('Request context', t => {
  ...
  t.test('custom value', t => {
    ...
    client.request({}, { context: { winter: 'is coming' } }, t.error)
  })
  ...
  t.test('override global', t => {
    ...
    client.request({}, { context: { winter: 'has come' } }, t.error)
  })
