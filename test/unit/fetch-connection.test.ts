...
import { errors, } from '../..'
// import { FetchConnection, errors, ConnectionOptions } from '../..'
// import net from "net";
// import { test } from 'tap'
// import { URL } from 'url'
// import * as http from 'http'
// import { buildServer } from '../utils'
import FetchConnection from '../../src/connection/FetchConnection'
...
test('Basic (fetch)', async t => {
  ...
  t.match(res.headers, { connection: /keep-alive/ }, 'No keep alive')
  t.equal(res.body, 'ok', 'Incorrect')
  server.stop()
})
...
//   class MyConnection extends FetchConnection {
